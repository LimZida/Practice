...
public interface MenuService {
    List<Menu> selectMenuDepthService(MenuDto.depthInfo depthInfo);
    List<Menu> selectMenuCodeService(MenuDto.codeInfo codeInfo);
    Menu saveMenuService(MenuDto.saveInfo saveInfo);
}
